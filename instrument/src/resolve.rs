...
impl ResolutionInstrument {
    fn read(&self, message: &DnsMessage, _now_ms: u64) -> Option<Resolved> {
        ...
        // Замер 12.09.2026 (`dig +norec +dnssec +bufsize=512 +ignore`): `a0.org.afilias-nst.info`
...
mod tests {
    ...
    ///
    /// Замер 12.09.2026, `dig +norec +dnssec +bufsize=512 +ignore`: авторитетные `a0.org.afilias
