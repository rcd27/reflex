...
//!
//! Он не говорит «нас цензурируют». Документация фильтрующего оборудования (параметр `send RST off`,
//! «всегда должен быть в режиме off») описывает ровно ту картину, которую мы
