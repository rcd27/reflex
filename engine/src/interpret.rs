...
//! ЭТО В СЧЁТ** (какой ноге приписать беду) живёт в `domain::finding::trouble`, потому что нога
...
mod tests {
    ...
    /// (`domain::finding::trouble`): потеряй мы имя ноги ТАМ, беда на обходе понизила бы оценку
