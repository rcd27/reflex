...
# аплинк (ТСПУ линии замера). Доказываем: чужой движку автомат Мили ловит тихий дроп на живом трафике.
set -u

TARGET=${TARGET:-rutracker.org}   # тихий дроп по SNI на этой линии замера
