...
//!
//! Третья дверь — о ЦЕЛИ: `.about(свёртка)` сводит слова разговоров цели в одно, `.on_target` его
//! слышит. Двадцать потоков к молчащему сайту дают одно высказывание вместо двадцати, и приходит
//! оно ОТДЕЛЬНОЙ реакцией — область у него другая, чем у слов разговоров.
//!
//! ## Запуск
//!
//! ```sh
