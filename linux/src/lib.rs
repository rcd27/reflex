...
#[deprecated(
    since = "0.0.1",
    note = "фичу `tc` включает только закрытый продукт первого поколения; разбор техники отложен — см. заголовок lib.rs"
)]
pub mod tc;
...
#[deprecated(
    since = "0.0.1",
    note = "фичу `tun` включает только закрытый продукт первого поколения; разбор техники отложен — см. заголовок lib.rs"
)]
pub mod tun;
