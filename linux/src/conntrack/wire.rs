...
/// зовёт netlink, а тем, кто его строит здесь ([`tuple_of`]), и тем, кто его читает выше по стеку
/// (`reflex-engine::parse::keyed_of_orig`), ОДНО определение честнее второй копии одной формы.
