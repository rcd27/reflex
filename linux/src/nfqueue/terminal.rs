...
///
/// Сборка `RST` жила в продукте (`nevod2_runtime::petlya::rst_to_client`), и потому определение
...
/// молча, и дороже всех именно этот: дроп без извещения есть ровно то, чем бьёт ТСПУ.
///
