...
//
// Три заявления покрывают три слова алфавита из четырёх. Четвёртое, `Marked`, способности не
// получило НАМЕРЕННО и с названной ценой: метка не видна на проводе, она живёт внутри ядра, и
// свидетелем ей может быть только счётчик правила, читающего эту метку. Пока такого свидетеля
// нет, заявление было бы ровно тем, что мы весь день сносили, — высказыванием без предмета.
