...
///
/// Движок десинка на всех коробках умер при старте (после сброса привилегий не прочёл свой lua), а
/// продукт сутки печатал «нога несёт»: свидетельство выдавал `spawn`, то есть ОБЪЯВЛЯЮЩИЙ. Правило
...
mod listened_tests {
    ...
    /// Очереди в файле нет — её никто не слушает. Ровно это и было на коробках 15.09: 240 не было,
