...
///
/// Знание о цели при этом не разъезжается по транспортам, и общий ключ разговора для этого не
/// нужен: слив нужен ЦЕЛИ, а не разговору. Цель — отдельный слой (`TargetKey` протокола не несёт),
/// и сводит её копредел по слою.
#[test]
