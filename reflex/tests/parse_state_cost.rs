...
fn what_the_parsing_keeps_per_conversation_has_a_named_price() {
    ...
    // ПОРЯДОК — правка, удесятерившая цену, уронит тест, а не будет найдена через сутки на коробке.
    assert!(
        per_flow < 3072,
...
/// роняла приёмку, а не обнаруживалась приростом RSS на пяти живых коробках за сутки.
#[test]
