...
/// одни заголовки — иначе час трафика машины не помещается ни в какую память, — и закон здесь
...
/// ПРЕДМЕТ: ЗАПИСЬ ДЕРЖИТ ПОТОЛОК. Машине отведена память, а не диск: поколение, дошедшее до
/// потолка, уступает место новому, старшие сдвигаются, лишнее уходит. Каждое поколение обязано
/// читаться само по себе — иначе снятый с машины файл нечем прогнать.
#[test]
