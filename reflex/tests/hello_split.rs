...
///
/// В бою порядок не обещан никем: голова приветствия могла быть дропнута до нашего хука и прийти
...
/// поднималось НИКОГДА.
///
/// Симптом у потребителя был именно такой: на ЗАПИСИ той же беседы имя поднималось, в бою — ни
