...
#[test]
fn a_retransmit_from_a_target_without_progress_reaches_the_reaction() {
...
#[test]
fn a_target_that_keeps_making_progress_raises_no_trouble() {
    let heard = log::<Distress>();
...
#[test]
fn a_target_that_closed_the_conversation_without_a_single_byte_is_named() {
    let heard = log::<Distress>();
...
#[test]
fn a_target_that_spoke_and_then_closed_raises_no_trouble() {
    let heard = log::<Distress>();
