...
//!
//! Дроп без извещения есть ровно то, чем бьёт ТСПУ: клиент не узнаёт, что разговора не будет,
...
/// ИЗВЕЩЕНИЯ НЕТ: пакет не прошёл, а клиент об этом не знает — то самое, чем бьёт ТСПУ.
#[test]
