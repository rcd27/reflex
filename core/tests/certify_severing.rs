...
//! ретрансмитит приветствие пять-семь раз и ждёт от двух до двенадцати секунд (замер на нашей
//! линии 04.09.2026). Человек называет это «страница висит». Обрыв же с извещением клиент
