...
//!
//! Домашнее правило репы: «перебор всех состояний строже любого property-раннера и не требует
//! новой зависимости». Мир конечен, равенство НАБЛЮДАТЕЛЬНОЕ: две цепочки равны, если на всех
//! входах дают один выход.
//!
...
//! `E0382: use of moved value: self.1` — проверено прогоном, не выведено. То есть ассоциативность
//! здесь сторожит РЕГРЕССИЮ СИГНАТУРЫ, а не логику, и умолчать об этом значило бы выдать сторожа
//! сигнатуры за сторожа закона.
//!
