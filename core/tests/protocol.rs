//! ПРОТОКОЛЫ — три закона вместо семнадцати случаев.
//!
//! Не представители таблицы, выбранные рукой (`tcp_from_u8`, `udp_from_u8`, `icmp_from_u8`,
//! `zero_is_other`, `255_is_other`, и так далее — 15 случаев из 17 суть один `assert`). Выбор
//! представителей и есть место, где теряется случай: у флагов TCP тем же способом потерялся `PSH`,
//! и тридцать два теста этого не заметили.
//!
