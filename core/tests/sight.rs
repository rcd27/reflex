...
//!
//! Слепота — свойство не одной плоскости, а ВСЯКОГО перехватывающего движка: NFQUEUE роняет под
//! нагрузкой, кольцо AF_PACKET переполняется, WinDivert теряет по-своему. Движок, не умеющий
//! сказать «я этого не видел», выдаёт своё молчание за молчание сети.
