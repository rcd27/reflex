...
pub struct TestClock {
    ...
    /// целях без 64-битных атомиков — `mips`, `mipsel`, `powerpc`: модуль публичный (рядом боевой
    /// [`OsClock`]), тестовый дубль компилируется в каждой релизной сборке и отнимает три
    /// архитектуры ради кода, который в бою не исполняется никогда. Замерено: `cargo check
